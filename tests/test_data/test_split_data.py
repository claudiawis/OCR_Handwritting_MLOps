...
class TestDataSplitting(unittest.TestCase):
    ...
    def test_split_data(self):
        ...
        # Run the code from the script directly or mock the results
        ...
        self.assertAlmostEqual(len(X_train) / total_data, 0.8, delta=0.1, msg="Training data is not approximately 80% of the total data.")
        self.assertAlmostEqual(len(X_test) / total_data, 0.2, delta=0.1, msg="Test data is not approximately 20% of the total data.")
